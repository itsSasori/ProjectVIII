...
# Load CSV data
disease_info = pd.read_csv(os.path.join(settings.BASE_DIR, 'tomato_disease_info1.csv'), encoding='cp1252')
...
state_dict_path = os.path.join(settings.BASE_DIR, "plant_disease_model_1_latest (4).pt")
...
def prediction(image_path, model):
    try:
        ...
        with torch.no_grad():
            ...
            confidence = probabilities[0, index] * 100  # Convert to percentage
